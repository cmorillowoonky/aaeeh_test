...
const Inscripcion = () =>(
    <Layout>
        ...
        <table style={{
            ...
            <tr>
                <td style={{paddingLeft:'2rem',border: '5px solid #00A97D',}}>
                Socios A.A.E.E.H.,<br></br> con cuota al día
                </td>
                <td style={{border: '5px solid #00A97D',}}>Sin Cargo</td>
             </tr>
             ...
             <tr>
                ...
                <td style={{border: '5px solid #00A97D',}}>$3000</td>
             </tr>
             <tr>
                <td style={{paddingLeft:'2rem',border: '5px solid #00A97D',}}>
             ...
             <tr>
                ...
                <td style={{border: '5px solid #00A97D',}}>$1500</td>
             </tr>
             <tr>
                <td style={{paddingLeft:'2rem',border: '5px solid #00A97D',}}>
             ...
             <tr>
                ...
                <td style={{border: '5px solid #00A97D',}}>$1200</td>
             </tr>
             ...
             <tr>
                ...
                <td style={{border: '5px solid #00A97D',}}>200 USD</td>
             </tr>
